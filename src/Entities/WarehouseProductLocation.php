...
class WarehouseProductLocation extends WebServiceModel
{
    /* @ResourceType :deprecated*/
    public static $resource = 'warehouse_product_locations';

    public static $xmlNode = 'warehouse_product_location';
